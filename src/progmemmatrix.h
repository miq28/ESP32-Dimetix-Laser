...
// addition for ESP32
// SPI RAM
const char pgm_psramsize[] PROGMEM = "psramsize";
const char pgm_freepsram[] PROGMEM = "freepsram";
const char pgm_minfreepsram[] PROGMEM = "minfreepsram";
const char pgm_maxallocpsram[] PROGMEM = "maxallocpsram";

const char pgm_heapsize[] PROGMEM = "heapsize";
// const char pgm_freeheap[] PROGMEM = "freeheap";
const char pgm_minfreeheap[] PROGMEM = "minfreeheap";
const char pgm_maxallocheap[] PROGMEM = "maxallocheap";

const char pgm_chiprevision[] PROGMEM = "chiprevision";
const char pgm_chipmodel[] PROGMEM = "chipmodel";
const char pgm_chipcores[] PROGMEM = "chipcores";
const char pgm_cpufreqmhz[] PROGMEM = "cpufreqmhz";
// const char pgm_cyclecount[] PROGMEM = "cyclecount";
const char pgm_sdkversion[] PROGMEM = "sdkversion";
...
// const char pgm_sketchsize[] PROGMEM = "sketchsize";
const char pgm_sketchmd5[] PROGMEM = "sketchmd5";
// const char pgm_freesketchspace[] PROGMEM = "freesketchspace";
